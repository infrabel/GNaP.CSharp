...
nuget pack src\GNaP.DependencyInjection.Web\GNaP.DependencyInjection.Web.csproj -Build -Prop Configuration=Release -Exclude gnap.ico

ECHO Packing GNaP.Core
nuget pack src\GNaP.Core\GNaP.Core.csproj -Build -Prop Configuration=Release -Exclude gnap.ico
